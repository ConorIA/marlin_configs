...
#define USE_CONTROLLER_FAN
  ...
  //#define CONTROLLER_FAN_PIN PE5 // -1           // Set a custom pin for the controller fan
...
#define HOMING_BUMP_MM     { 5, 5, 0 } // { 5, 5, 2 }       // (mm) Backoff from endstops after first bump
...
#define ARC_SUPPORT                   // Requires ~3226 bytes
  ...
  #define MIN_ARC_SEGMENT_MM      0.2 // 0.1 // (mm) Minimum length of each arc segment
 ...
 */
  ...
  #define SENSORLESS_HOMING // StallGuard capable drivers only
    ...
    #define X_STALL_SENSITIVITY  96 // 8
    #define X2_STALL_SENSITIVITY X_STALL_SENSITIVITY
    #define Y_STALL_SENSITIVITY  96 // 8
    #define Y2_STALL_SENSITIVITY Y_STALL_SENSITIVITY
    //#define Z_STALL_SENSITIVITY 48 // 8
